...
- [bezt-mcp](https://github.com/bezt-dev/bezt-mcp) - Curated best practices for 1000+ technologies (React, Python, Docker, AWS, security, etc.). Two MCP tools: search topics and fetch expert-verified guidelines as Markdown. Python, stdio transport. Free, open-source.
